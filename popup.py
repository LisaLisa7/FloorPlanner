...
class UI_MessageWindow(QDialog):
    ...
    def get_measurements(self):
        ...
        try:
            ...
            if length < 500:
                print("Prea mica lungimea, minimul trebuie să fie 500")
                length = 500

            if width < 250:
                print("Prea mica lățimea, minimul trebuie să fie 250")
                width = 250
    ...
    def __init__(self,parent=None):
        ...
        # conectare functii la butoane
        ok_button.clicked.connect(self.accept)

        cancel_button.clicked.connect(self.reject)

        # creare layout pentru organizarea widget-urilor
        layout = QVBoxLayout()
        ...
        # setare layout pentru fereastra de dialog
